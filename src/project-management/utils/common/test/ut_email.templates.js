...
describe("email.templates", () => {
  describe("confirm", () => {
    it("should return the correct confirm object", () => {
      ...
      const expectedConfirmObject = {
        subject: "STI Analytics JOIN request",
        html: `<a href='${constants.CLIENT_ORIGIN}/confirm/${id}'>Click to know more about STI</a>`,
  ...
  describe("inquiryTemplate", () => {
    it("should return the correct inquiry template with full name", () => {
      ...
      <br> 
      <a href=${constants.PLATFORM_BASE_URL}> Check out STI Analytics</a>
  ...
  describe("emailVerification", () => {
    it("should return the correct email verification template with provided details", () => {
      ...
      <p> Thank you for signing up for STI Analytics! We are excited to have you on board.</p>
      <p> Before you can fully access all of the features and services offered by STI Analytics, we need to verify your account. </p>
      ...
      <br>
      <p> Thank you for choosing STI Analytics, and we look forward to helping you achieve your goals</p>
      <br>
      <p> Sincerely,</p>
...
<p> We are pleased to inform you that you can now fully access all of the features and services offered by STI Analytics.</p>
<br>
...
<p> With the STI app, you'll have access to:<p/>
