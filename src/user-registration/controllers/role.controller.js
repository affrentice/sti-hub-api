...
const rolePermissionUtil = require("@utils/role.permissions.util");
const {
  logObject,
  logText,
  logElement,
...
const createRole = {
  list: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.listRole(request, next);
  ...
  create: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.createRole(request, next);
  ...
  update: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.updateRole(request, next);
      if (isEmpty(result) || res.headersSent) {
        return;
      }
      if (result.success === true) {
  ...
  delete: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.deleteRole(request, next);
      if (isEmpty(result) || res.headersSent) {
        return;
      }
      if (result.success === true) {
  ...
  listUsersWithRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.listUsersWithRole(request, next);
  ...
  listAvailableUsersForRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.listAvailableUsersForRole(
        request,
        next
      );
  ...
  assignUserToRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.assignUserToRole(request, next);
  ...
  assignManyUsersToRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.assignManyUsersToRole(
        request,
        next
      );
  ...
  unAssignUserFromRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.unAssignUserFromRole(
        request,
        next
      );
  ...
  unAssignManyUsersFromRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.unAssignManyUsersFromRole(
        request,
        next
      );
  ...
  listPermissionsForRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.listPermissionsForRole(
        request,
        next
      );
  ...
  listAvailablePermissionsForRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.listAvailablePermissionsForRole(
        request,
        next
      );
  ...
  assignPermissionToRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.assignPermissionsToRole(
        request,
        next
      );
  ...
  unAssignPermissionFromRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.unAssignPermissionFromRole(
        request,
        next
      );
  ...
  unAssignManyPermissionsFromRole: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.unAssignManyPermissionsFromRole(
        request,
        next
      );
  ...
  updateRolePermissions: async (req, res, next) => {
    try {
      ...
      const result = await rolePermissionUtil.updateRolePermissions(
        request,
        next
      );
