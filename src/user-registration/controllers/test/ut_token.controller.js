...
describe("tokenUtil", () => {
  describe("create", () => {
    ...
    beforeEach(() => {
      ...
      controlAccessUtilStub = sinon.stub(tokenUtil, "tokenUtil");
    });
  ...
  describe("list", () => {
    ...
    beforeEach(() => {
      ...
      validationResultStub = sinon
        ...
        .returns(true);
      badRequestStub = sinon.stub(tokenUtil, "badRequest").returns(res);
      controlAccessUtilStub = sinon.stub(tokenUtil, "listAccessToken");
    });
  ...
  describe("verify", () => {
    ...
    beforeEach(() => {
      ...
      validationResultStub = sinon
        ...
        .returns(true);
      badRequestStub = sinon.stub(tokenUtil, "badRequest").returns(res);
      controlAccessUtilStub = sinon.stub(tokenUtil, "verifyToken");
    });
  ...
  describe("delete", () => {
    ...
    beforeEach(() => {
      ...
      validationResultStub = sinon
        ...
        .returns(true);
      badRequestStub = sinon.stub(tokenUtil, "badRequest").returns(res);
      controlAccessUtilStub = sinon.stub(tokenUtil, "deleteAccessToken");
    });
  ...
  describe("update", () => {
    ...
    beforeEach(() => {
      ...
      validationResultStub = sinon
        ...
        .returns(true);
      badRequestStub = sinon.stub(tokenUtil, "badRequest").returns(res);
      controlAccessUtilStub = sinon.stub(tokenUtil, "updateAccessToken");
    });
