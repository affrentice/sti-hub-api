    ...
    it("should return the correct join request message with valid first name, last name and email", () => {
      ...
      const content = ` <tr>
                                <td
                                    ...
                                    Your request to join STI Analytics has been received, we shall get back to you as soon as possible.
                                    <br />
                                    <br />
                                    Before utilising the STI data, your application record has to undergo the process of approval by STI Analytics
                                    administration.
                                    <br />
          ...
          case "champions":
            content = ` <tr>
                                ...
                                members to take action against air pollution.
                                    <br />
                                    Please get in touch with our Marketing and Communications Lead at maclina@sti.go.ug for further support.
                                    <br />
                                </td>
                            </tr>`;
            break;
          case "researchers":
            content = ` <tr>
                            ...
                            click <a href="https://sti.go.ug/explore-data">here</a> to access data.
                                    <br />
                                    If you still need further support, please contact our Data Scientists Richard Sserujogi at Richard@sti.go.ug or Wabinyai
          ...
          case "developers":
            content = `<tr>
                                ...
                                Thank you for your interest in our work.
                                    <br />
                            Please get in touch with our Software Engineering Lead Martin Bbaale at martin@sti.go.ug for further support.
                                    <br />
                                </td>
                            </tr>`;
            break;
          ...
          default:
            content = `<tr>
                                ...
                                Cities.
                                    ...
                                    deo@sti.go.ug for further support.
                                    <br />
                                </td>
                            </tr>`;
            break;
  ...
  describe("welcome_kcca", () => {
    it("should return the correct welcome message for KCCA with valid inputs", () => {
      ...
      const content = ` <tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                    Welcome to the KCCA STI air quality monitoring platform.
                                    <br />
                                    ...
                                    <br />
                                    A guide to using STI Analytics will be found under the Documentation section of STI Analytics
                                    <br /><br />
  ...
  describe("welcome_general", () => {
    it("should return the correct welcome message with valid inputs", () => {
      ...
      const content = `<tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                    Welcome to STI Analytics. Your login credentials are as follows:
                                    <br />
                                    YOUR USERNAME: ${email}
                                    <br />
                                    ...
                                    <br />
                                    After login, you can change your password in your account settings. You can also use your STI Analytics credentials to
                                    access the STI API.
                                    <br />
                                    The STI API reference can be found here: <a href=" https://docs.sti.go.ug/sti-rest-api-documentation/">API
                                        Documentation</a>
                                    <br /><br />
                                    By actively utilising STI Analytics, you automatically agree to the <a
                                        href="https://docs.sti.go.ug/sti-terms-and-conditions/HxYx3ysdA6k0ng6YJkU3/">STI terms and conditions:</a>
                                    <br />
                                    ...
                                    <br />
                                    To learn more about STI Analytics and its features, please refer to the <a
                                        href="https://docs.sti.go.ug/sti-platform/">user guide available here:</a>
                                    <br /><br />
                                    Best regards,
                                    <br />
                                    STI Data Team
  ...
  describe("user_updated", () => {
    it("should return the correct user_updated message with valid inputs", () => {
      ...
      const content = ` <tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                Your STI Analytics account details have been updated.
                                    <br />
                                    ...
                                    <br />
                                    Follow this link to access STI Analytics right now: ${constants.LOGIN_PAGE}
                                    <br />
                                    <br />
                                </td>
                            </tr>`;
  ...
  describe("forgotten_password_updated", () => {
    it("should return the correct forgotten_password_updated message with valid inputs", () => {
      ...
      const content = ` <tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                Your STI Analytics account password has been successfully reset.
                                <br />
                                If you did not initiate this password reset, please reach out to your organization's administrator immediately.
                                    <br />
                                    <br />
                                    Follow this link to access <a href="${constants.LOGIN_PAGE}">STI Analytics right now:</a>
                                    <br />
  ...
  describe("known_password_updated", () => {
    it("should return the correct known_password_updated message with valid inputs", () => {
      ...
      const content = `<tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                Your STI Analytics account password has been successfully updated.
                                <br />
                                If you did not initiate this password reset, please reach out to your organization's administrator immediately.
                                    <br />
                                    <br />
