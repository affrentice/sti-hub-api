...
module.exports = {
  ...
  inquiryTemplate: (fullName) => {
    return `
    <h3>Hi ${fullName}</h3>
    <p>We are excited to welcome you to STI and we are even more excited about what we have got planned. You are already on your way to creating beautiful visual products.</p>
    <br> 
    ...
    <br> 
    <a href=${constants.PLATFORM_BASE_URL}> Check out Innovation Hub</a>
    ...
    <br> 
    <p>Thank you for signing up. If you have any questions, send us a message at info@sti.go.ug or on <a href=${constants.TWITTER_ACCOUNT}>Twitter</a>. We would love to hear from you.</p>
    <br> 
    <p>--The STI team.</p>
    </div>`;
  },
...
<p> Thank you for signing up for Innovation Hub! We are excited to have you on board.</p>
<p> Before you can fully access all of the features and services offered by Innovation Hub, we need to verify your account. </p>
...
<br>
<p> If you have any questions or need assistance with the verification process, please don't hesitate to reach out to our support team: support@sti.go.ug.</p>
<br>
...
`;
    ...
    const content = `<tr>
                                <td
                                    ...
                                    <div
                                        ...
                                        You can set a permanent password anytime within your Innovation Hub personal settings<br />Didn't make this
  ...
  acceptInvitation: ({
    ...
    const content = `<tr>
      ...
      entity_title
                                    ...
                                    <br /><br />
                                    Use Innovation Hub to access real-time air pollution location data for research and gain access to device management tools. Drive meaningful change, city location at a time.
                                    <br /><br />
                                    <a href=${url} target="_blank">
                                        <div
                                            style="width: 20%; height: 100%; padding-left: 32px; padding-right: 32px; padding-top: 16px; padding-bottom: 16px; background: #135DFF; border-radius: 1px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
  ...
  afterEmailVerification: (firstName, username, email) => {
    ...
    const content = ` <tr>
                                ...
                                <br />
                                We are pleased to inform you that you can now fully access all of the features and services offered by Innovation Hub.
                                <br />
                                <ul>
                                ...
                                <br />
                                Thank you for choosing Innovation Hub, and we look forward to helping you achieve your goals
                                <br />
                                <br />
                                Sincerely,
                                <br />
  ...
  afterAcceptingInvitation: ({ firstName, username, email, entity_title }) => {
    ...
    const content = ` <tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                Congratulations! You have successfully joined ${entity_title} organisation on Innovation Hub.
                                <br />
                                We are pleased to inform you that you can now access ${entity_title} data, insights and visualisations on Innovation Hub.
                                <br />
                                <ul>
                                    <li>YOUR USERAME: ${username}</li>
  ...
  deleteMobileAccountEmail: (email, token) => {
    const content = ` <tr>
                                <td
                                    style="color: #344054; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word;">
                                    We received your request to delete your STI account. Before we proceed, we need to verify your identity. Please follow
                                    ...
                                    Please note that deleting your account will permanently remove all your data associated with STI. This action cannot
                                    be undone.
                                    <br /><br />
                                    
                                    If you did not initiate this request, please contact our support team immediately.
                                    Thank you for using STI.
